   ...
   <div class="overflow-hidden mt-3">
       <div class="row  justify-content-center ">
        <div class="col-lg-6 col-md-8 col-sm-9 col-10 ">
            <form class="form" method="post" action="{{url('question_upload')}}">
                @csrf
            <div class="questionbox">
                <h4 class="rtl text-center"> سوال پوچھیں</h4>
                <div class="form-group">
                    <label for="" class="rtl float-right">نام سائل</label>
                    <input name="name" id="txtBox3" type="text" class="form-control rtl" >
                </div>
                <div class="form-group">
                    <label for="" class="float-right">ای میل ایڈریس</label>
                    <input name="email" type="email" class="form-control" >
                </div>
                <div class="form-group">
                    <label class="float-right">فون نمبر </label>
                    <input type="number" name="phone" class="form-control" placeholder="">
                </div>
                <div class="form-group">
                    <label for="" class="float-right">سوال کی عبارت</label>
                    <textarea name="explain" id="txtBox4" class="form-control rtl"  cols="30" rows="4"></textarea>
                </div>
                <div class="d-flex justify-content-end">
                    <button class="submit rtl ">سوال بھیجیں</button>
                </div>
            </div>
        </form>
        </div>
