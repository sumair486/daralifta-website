    ...
    <div class="row  justify-content-center">
        <div class="col-lg-4 col-md-6 col-11 order-lg-3  order-md-2 d-flex justify-content-center align-items-center  py-2 px-4">
            <div class="col-one w-100 h-100 px-2">
                <h5 class="rtl">قسم/Categories </h5>

                <ul>
                    @foreach ($categories as $category)

                    <li class="rtl"><a href="{{ route('category.related',$category->id) }}"> <span class="fa fa-regular fa-place-of-worship"></span> {{ $category->name }} </a></li>
        ...
        <div class="col-lg-8 col-md-6  col-11 order-lg-2 order-md-1 d-flex justify-content-center align-items-center  py-2 px-4">
