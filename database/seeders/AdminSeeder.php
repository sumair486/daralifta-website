...
class AdminSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission = Permission::create(['name' => 'Donation access']);
        $permission = Permission::create(['name' => 'Donation delete']);

        $permission = Permission::create(['name' => 'Question access']);
        $permission = Permission::create(['name' => 'Question edit']);
        $permission = Permission::create(['name' => 'Question create']);
        $permission = Permission::create(['name' => 'Question delete']);
